...
const Experience: React.FC = () => {
  return (
    ...
    >
      <h1 className="font-pixel text-3xl md:text-4xl text-gray-500">{'Contact'}</h1>
      <div className="flex flex-col items-center gap-2 md:gap-8">
        {/* info block */}
        <div className={'mt-6 py-4'}>
          <div className={'font-semibold text-md lg:text-lg font-pixel'}>
            <a href="mailto:duckdev45@gmail.com" className="hover:underline">
              Email:duckdev45@gmail.com
            </a>
          </div>
        </div>
      </div>
